...
const form = document.querySelector(".lorem-form"); // form container
const amount = document.getElementById("amount"); // input
const result = document.querySelector(".lorem-text"); // articles text

form.addEventListener("submit", function (e) {
  e.preventDefault();
  const value = parseInt(amount.value); // input value changed number
